...
// Insert the code before CREDITS tab
if (content.includes("{tierType === 'CREDITS' && (() => {")) {
  content = content.replace("{tierType === 'CREDITS' && (() => {", freeTabCode + "\n        {tierType === 'CREDITS' && (() => {");
  fs.writeFileSync(file, content, 'utf8');
  console.log("Successfully added Free Tab UI!");
} else {
  console.log("Could not find anchor to inject Free tab.");
}
