...
def verify_routine_page():
    with sync_playwright() as p:
        ...
        page.evaluate('''
            ...
            window.localStorage.setItem('iic_user', JSON.stringify({id: "user123", role: "STUDENT"}));
        ...
        page.screenshot(path='/home/jules/verification/routine_card_timer4.png', full_page=True)
