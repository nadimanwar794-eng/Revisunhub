...
export const TIER_THEME = {
  ultra: {
    ...
    text:          '#0d0e26',
    soft:          '#f0f2fa',
    navGlow:       'rgba(21,22,59,0.22)',
    navBorder:     'rgba(99,102,241,0.25)',
    navRing:       'rgba(21,22,59,0.30)',
  ...
  basic: {
    ...
    text:          '#1a1a1a',
    soft:          '#f5f5f5',
    navGlow:       'rgba(66,66,66,0.18)',
    navBorder:     'rgba(255,255,255,0.18)',
    navRing:       'rgba(66,66,66,0.25)',
  ...
  free: {
    ...
    text:          '#1f1f1f',
    soft:          '#f5f5f5',
    navGlow:       'rgba(130,130,130,0.18)',
    navBorder:     'rgba(148,163,184,0.18)',
    navRing:       'rgba(130,130,130,0.25)',
...
export const buildGranularTierTheme = (
  ...
  const resolvedNavBg = (() => {
    if (t.navBg && t.navBg !== '#ffffff') return t.navBg;
    if (t.bgColor && t.bgColor !== '#ffffff' && t.bgColor !== '#f8fafc' && t.bgColor !== '#f1f5f9') {
      return t.bgColor;
    }
    return `rgb(${rBgD},${gBgD},${bBgD})`;
  })();
  ...
  return {
    ...
    navInactive:     (t.navInactive && t.navInactive !== '#ffffff') ? t.navInactive : '#94a3b8',
